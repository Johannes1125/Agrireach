...
const reviewCategories = {
  product: ["Product Quality", "Delivery", "Communication", "Value for Money", "Packaging"],
  service: ["Work Quality", "Punctuality", "Communication", "Professionalism", "Value for Money"],
}
...
export default function WriteReviewPage() {
  ...
  const selectedUserData = availableUsers.find((user) => user.id.toString() === selectedUser)
  const categories = selectedUserData ? reviewCategories[selectedUserData.type as keyof typeof reviewCategories] : []
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <Link href="/reviews" className="inline-flex items-center text-muted-foreground hover:text-foreground">
      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground font-sans mb-2">Write a Review</h1>
          <p className="text-muted-foreground">Share your experience to help build trust in our community</p>
        </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground">{user.recentTransaction}</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Click the stars to rate your experience with {selectedUserData.name}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <Label>Would you recommend {selectedUserData.name} to others?</Label>
                    <RadioGroup
              ...
              <Card>
                ...
                <CardContent>
                  <ul className="text-sm text-muted-foreground space-y-1">
                    ...
                    <li>• Focus on your actual experience with the person or product</li>
                    <li>• Avoid personal attacks or inappropriate language</li>
                    <li>• Include specific details that would help other users</li>
                    <li>• Reviews are public and will be associated with your profile</li>
                  </ul>
                </CardContent>
              </Card>
